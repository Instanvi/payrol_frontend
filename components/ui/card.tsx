...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card flex min-h-[10rem] flex-col gap-(--card-spacing) overflow-hidden rounded-[2px] border-0 bg-card py-(--card-spacing) text-sm text-card-foreground shadow-none [--card-spacing:--spacing(8)] has-[>img:first-child]:pt-0 data-[size=sm]:min-h-0 data-[size=sm]:[--card-spacing:--spacing(5)] *:[img:first-child]:rounded-t-[2px] *:[img:last-child]:rounded-b-[2px]",
        className
      )}
      {...props}
    />
